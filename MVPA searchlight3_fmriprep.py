...
for mySujet in Sujet:
   ...
   myFunc1 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run1')
   myFunc2 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run2')
   myFunc3 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run3')
   myFunc4 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run4')
   myFunc5 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run5')
   myFunc6 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run6')
   myFunc7 = os.path.join('/home/mulaw/Documents/ELIE/fmriprep', SujNum, 'resultats', 'RSA_MVPA_duree_erreur_run7')
    
    
   # Prendre le bon nombre de beta
   betaFile = pd.read_csv('/home/mulaw/Documents/ELIE/Bigraphe_analyse/MVPA beta/MVPA_betaMax.csv')
   ...
   labels = pd.read_csv('/home/mulaw/Documents/ELIE/Bigraphe_analyse/MVPA beta/MVPA_label_complex_' + SujNum + '.csv')
...
# Masking 
   ...
   masker_file2 = os.path.join('/home/mulaw/Documents/ELIE/sujet/', SujNum, 'anat', masker_file)
   masker = NiftiMasker(masker_file2)
   #region_data = masker.fit_transform(fmri_img)
# Prendre la T1 non normalisee
   T1w_file= SujNum + '_T1w.nii'
   T1w = os.path.join('/home/mulaw/Documents/ELIE/sujet/RSA', SujNum, 'anat', T1w_file)
   plot_roi(masker.mask_img, bg_img=T1w, title='expliciteMask SPM') 
...
#plot_img(score_img1)
   ...
   output_path1 = os.path.join('/home/mulaw/Documents/ELIE/resultats MVPA/MVPA Searchlight', SujNum + "fmriPrep_ARvsFR_" + "accMap_")
   scores_img1.to_filename(output_path1)
         
   output_path2 = os.path.join('/home/mulaw/Documents/ELIE/resultats MVPA/MVPA Searchlight', SujNum + "fmriPrep_ARvsFR_" + "tMap_")
